...
public class CaesarDecryptionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caesar_decryption);
    ...
    private void decryptText() {
        ...
        String decryptedText = caesarDecipher(text, shift);
        outputText.setText(decryptedText);
    }

    private String caesarDecipher(String text, int shift) {
        shift = shift % 26; // Обмеження зсуву до діапазону від 0 до 25
    ...
    private void saveTextToDevice(String text) {
        ...
        intent.setType("text/plain");
        intent.putExtra(Intent.EXTRA_TITLE, "decrypted_text_Caesar.txt");
    ...
    private File saveEncryptedTextToFile(String text) {
        try {
            File file = new File(getExternalFilesDir(null), "decrypted_text_Caesar.txt");
