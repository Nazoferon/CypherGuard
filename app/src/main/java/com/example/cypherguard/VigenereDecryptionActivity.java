...
public class VigenereDecryptionActivity extends BaseActivity {
    ...
    private void decryptText() {
        ...
        String decryptedText = vigenereDecipher(text, key);
    ...
    private String vigenereDecipher(String text, String key) {
        ...
        for (char character : text.toCharArray()) {
            if (Character.isLetter(character)) {
                ...
                int keyShift = Character.isUpperCase(keyChar) ? keyChar - 'A' : keyChar - 'a';
                result.append((char) ((character - base - keyShift + 26) % 26 + base));
                keyIndex++;
            } else {
    ...
    private void saveTextToDevice(String text) {
        ...
        intent.setType("text/plain");
        intent.putExtra(Intent.EXTRA_TITLE, "decrypted_text_Vigenere.txt");
    ...
    private File saveEncryptedTextToFile(String text) {
        try {
            File file = new File(getExternalFilesDir(null), "decrypted_text_Vigenere.txt");
